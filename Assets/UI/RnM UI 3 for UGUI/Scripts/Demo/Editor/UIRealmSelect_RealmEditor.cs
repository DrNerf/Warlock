...
namespace UnityEditor.UI
{
	...
	public class UIRealmSelect_RealmEditor : SelectableEditor {
		...
		private SerializedProperty m_HighlighColorMultiplier;
		...
		private SerializedProperty m_CharactersNormalColorProperty;
		...
		protected override void OnEnable()
		{
			...
			this.m_HighlighColorMultiplier = this.serializedObject.FindProperty("m_HighlighColorMultiplier");
			...
			this.m_CharactersNormalColorProperty = this.serializedObject.FindProperty("m_CharactersNormalColor");
		}
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.LabelField("Highlight Color Properties", EditorStyles.boldLabel);
			EditorGUI.indentLevel = (EditorGUI.indentLevel + 1);
			EditorGUILayout.PropertyField(this.m_HighlighColorMultiplier, new GUIContent("Multiplier"));
			EditorGUI.indentLevel = (EditorGUI.indentLevel - 1);
			...
			EditorGUILayout.PropertyField(this.m_CharactersNormalColorProperty, new GUIContent("Normal"));
			EditorGUI.indentLevel = (EditorGUI.indentLevel - 1);
